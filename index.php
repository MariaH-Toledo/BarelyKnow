                ...
                <div class="modal-body">
                    <form id="formCriar" action="view/criar_sala.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="rodadas" class="form-control form-control-dark" min="3" max="20" required>
                        </div>
                        ...
                        <div class="text-end">
                            ...
                            <button type="submit" class="btn btn-criar-index">Criar</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formEntrar" action="view/entrar_sala.php" method="POST">
                        ...
                        <div class="text-end">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                            <button type="submit" class="btn btn-entrar-index">Entrar</button>
                        </div>
                    </form>
                </div>
            </div>
